---
title: OMNIA ERP (Primavera) Connector Tutorial
keywords: omnia3
...
6. Navigate to tab *"[Data Behaviours](https://docs.omnialowcode.com/omnia3_modeler_datasources.html)"*, and define a behaviour to be executed on *"ReadList"*. This behaviour will be used for Query and List requests for this entity.
